pipeline {
  ...
  environment {
    ...
    EXT_USER = 'flyinghead'
    EXT_REPO = 'flycast'
    BUILD_VERSION_ARG = 'FLYCAST_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-flycast'
    CONTAINER_NAME = 'flycast'
    DOCKERHUB_IMAGE = 'linuxserver/flycast'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/flycast'
    PR_DOCKERHUB_IMAGE = 'lspipepr/flycast'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-flycast/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-flycast\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-flycast\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Flycast\" \
          --label \"org.opencontainers.image.description=[Flycast](https://github.com/flyinghead/flycast) is a multi-platform Sega Dreamcast, Naomi, Naomi 2, and Atomiswave emulator derived from reicast.\" \
